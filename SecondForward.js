...
function SecondForward() {
    ...
    const SecondForward = () => {
        ...
        var forward=(-fxipass3+4*fxipass2-5*fxipass1+2*fxi)/(h^2);
          
        const eror = Math.abs(((difffx-forward)/difffx)*100);
          queue_data.push({
        ...
        return(
                ...
                <div className = "App">
                    ...
                    <div className = "up-extext">
                        ...
                        <h1>Second Forward-Divide-Difference O(h^2)</h1>     
...
<h2> x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;h</h2>
                    ...
                    <button onClick={SecondForward}>Calculate</button>
                    <button onClick={set}>Set Value</button>

                    <div className = "App-table">

                      <Table style={{ marginTop: 30 }} dataSource={datashow}>
                        <Column title="forward" dataIndex="forward" key="forward" />
