...
function SecondCentral() {
    ...
    const SecondCentral= () => {
        ...
        var central=(-fxipass2+(16*fxipass1)-30*fxi+(16*fximinus1)-fximinus2)/(12*(h^2));
          
        const eror = Math.abs(((difffx-central)/difffx)*100);
          queue_data.push({
        ...
        return(
                ...
                <div className = "App">
                    ...
                    <div className = "up-extext">
                        ...
                        <h1>Second Central-Divide-Difference O(h^4)</h1>     
...
<h2> x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;h</h2>
                    ...
                    <button onClick={SecondCentral}>Calculate</button>
